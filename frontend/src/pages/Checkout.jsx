        ...
        <div className="row">
          <div className="col-lg-4">
            <h3>เลือกช่องทางชำระเงิน</h3>
              <div style={{ padding: '35px', border: '1px solid black', borderRadius: '15px' }} className="form-check bg-light">
                <input className="form-check-input" type="radio" defaultChecked={checked} />
