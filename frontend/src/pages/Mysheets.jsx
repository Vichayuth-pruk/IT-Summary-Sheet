...
function Mysheets(props) {
  ...
  useEffect(() => {
    setFilterDataList(() => dataList.filter(data => data.courseTitle.toLowerCase().includes(searchBox.toLowerCase())))
  }, [searchBox])
        ...
        <div className="row mt-5">
          <div className="col-md-5 ">
            <div className="input-group">
              <input className="form-control border-end-0 border" type="search" id="example-search-input" placeholder="search" onChange={text => setSearch(text.target.value)} />
